...
/**
 * Use claymorphism component for wrapping elements.
 */
var Claymorphism = react.exports.forwardRef(function (props, forwardedRef) {
    var internalRef = react.exports.useRef(null);
    var ref = forwardedRef || internalRef;
    var children = props.children, className = props.className; props.as; var clayBackgroundColor = props.clayBackgroundColor, clayBorderRadius = props.clayBorderRadius, clayOuterShadowColor = props.clayOuterShadowColor, clayShadowInsetPrimaryColor = props.clayShadowInsetPrimaryColor, clayShadowInsetSecondaryColor = props.clayShadowInsetSecondaryColor, rest = __rest(props, ["children", "className", "as", "clayBackgroundColor", "clayBorderRadius", "clayOuterShadowColor", "clayShadowInsetPrimaryColor", "clayShadowInsetSecondaryColor"]);
    /**
     *
     */
    var StyledClayMorphism = styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      background: ", ";\n      border-radius: ", ";\n      box-shadow: 8px 8px 16px ", ",\n        inset -8px -8px 16px 0 ", ",\n        inset 8px 8px 16px 0 ", ";\n    "], ["\n      background: ", ";\n      border-radius: ", ";\n      box-shadow: 8px 8px 16px ", ",\n        inset -8px -8px 16px 0 ", ",\n        inset 8px 8px 16px 0 ", ";\n    "])), clayBackgroundColor, clayBorderRadius, clayOuterShadowColor, clayShadowInsetPrimaryColor, clayShadowInsetSecondaryColor);
    /**
     *
     */
    var component = react.exports.useMemo(function () { return (React.createElement(StyledClayMorphism, __assign({ className: className }, rest, { ref: ref }), children)); }, [children, rest]);
    return component;
});
...
export { Claymorphism as default };
